...
const BLOCKED_CODES = [
    CCGTMS_BlockedCodes::AUTOMATION_TOOL,
    CCGTMS_BlockedCodes::CLICK_FARM,
    CCGTMS_BlockedCodes::CLICK_HIJACKING,
    CCGTMS_BlockedCodes::DISABLED_COOKIES,
    CCGTMS_BlockedCodes::DISABLED_JS,
    CCGTMS_BlockedCodes::EXCESSIVE_RATE_LIMIT,
    CCGTMS_BlockedCodes::FALSE_REPRESENTATION,
    CCGTMS_BlockedCodes::MALICIOUS_BOTS,
    CCGTMS_BlockedCodes::MALICIOUS_USER_INPUT,
    CCGTMS_BlockedCodes::NETWORK_ANOMALIES,
    CCGTMS_BlockedCodes::SCRAPERS
];
...
class RTI_Service
{
    ...
    public function validate_rti_response($response, $request_params)
    {
        ...
        if (!empty($response)) {
            ...
            } elseif (in_array($response->threatTypeCode, BLOCKED_CODES) && $response->isInvalid) {
                $res = [
                    "is_valid" => false,
                    "output" => $response,
                ];
